...
public class SimpleFSM : FSM 
{
    ...
    protected void UpdateDriftState()
    {
        ...
        if (!objPlayer.GetComponent<PlayerTankController>().withinCirlce)
        {
    ...
    protected void UpdatePatrolState()
    {
        ...
        else if(objPlayer.GetComponent<PlayerTankController>().withinCirlce)
        {
            print("Switch to Drift Postion");
            curState = FSMState.Drift;
            Drift.Play();
        }
